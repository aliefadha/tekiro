  ...
  const features = [
    {
      ...
      description:
        "Our tools are made from premium-grade materials to withstand rigorous use.",
      icon: (
        <svg
          aria-hidden="true"
          className="w-10 h-10"
    ...
    },
    {
      ...
      description:
        "We embrace cutting-edge technology and user-centric designs to ensure functionality and ease of use.",
      icon: (
        <svg
          aria-hidden="true"
          className="w-10 h-10"
    ...
    },
    {
      ...
      description:
        "Every product meets or exceeds international quality standards, reflecting our commitment to excellence.",
      icon: (
        <svg
          aria-hidden="true"
          className="w-10 h-10"
    ...
    },
    {
      ...
      description:
        "Tekiro is the preferred choice of mechanics, technicians, and enthusiasts worldwide.",
      icon: (
        <svg
          aria-hidden="true"
          className="w-10 h-10"
    ...
    <>
      <div className="flex flex-col md:flex-row w-full h-auto md:min-h-[650px] relative">
        ...
        <div className="w-full md:w-2/5 bg-[85E408] lg:bg-black z-10 p-4 md:p-0">
          <div className="bg-[#85E408] w-full max-w-none p-8 md:px-12 md:py-24 flex flex-col gap-5 md:-ms-24 my-0 md:my-24 ">
            <h1
              className={`${montserrat.className} font-bold uppercase text-3xl`}
            >
              ABOUT US
            </h1>
            <p className={`${montserrat.className} text-sm w-3/4 font-medium`}>
              Welcome to Tekiro Tools, a trusted name in the world of
              professional-grade hand tools since 1995. With over 29 years of
              expertise, we are committed to delivering innovative, durable, and
              high-quality tools to meet the diverse needs of professionals and
              hobbyists alike.
            </p>
            <Link href="/about-us" className="inline-block ">
              <h2
                className={`${montserrat.className} text-xl font-semibold uppercase underline underline-offset-8 decoration-[#427402] `}
              >
                learn more
              </h2>
            </Link>
      ...
      <div className="py-20 text-center">
        <h1 className={`${montserrat.className} font-bold uppercase text-3xl`}>
          Tekiro® FOR EVERYTHING & EVERYONE.
          <br />
      ...
      <div className="py-20 w-full mx-auto max-w-6xl flex flex-col gap-6">
        <div className="flex flex-col gap-5 text-center">
          ...
          <p className={`${montserrat.className} text-sm font-medium`}>
            Our Commitment to Sustainability We are dedicated to building a
            sustainable future by implementing eco-friendly practices in our
            manufacturing processes and promoting responsible resource usage.
          </p>
        </div>
          ...
          {features.map((feature) => (
            ...
            >
              <div className="flex flex-col lg:flex-row gap-4 items-center text-center lg:items-center">
                {/* Icon Wrapper */}
                <div className="shrink-0 p-0 lg:p-2.5">{feature.icon}</div>
                {/* Title */}
                <h3
                  className={`${montserrat.className} text-xl lg:text-3xl font-bold uppercase leading-tight w-full`}
                >
                  {feature.title}
                </h3>
              </div>
              ...
              {/* Description */}
              <p
                className={`${montserrat.className} text-sm font-medium ${feature.variant === "dark" ? "opacity-90" : "opacity-100"}`}
              >
                {feature.description}
              </p>
            </div>
      ...
      <div className="py-20 w-full mx-auto max-w-6xl flex flex-col gap-20 px-4 lg:px-0">
        <div className="flex flex-col gap-5 text-center">
          ...
          <p className={`${montserrat.className} text-sm font-medium`}>
            Tekiro Tools, we take pride in our dedication to excellence, which
            has been recognized through numerous awards and accolades. These
            achievements reflect our commitment to providing high-quality,
            durable, and user-friendly tools that meet the needs of our
            customers.
          </p>
          <p className={`${montserrat.className} text-sm font-medium`}>
            Our awards are a testament to the trust and loyalty of our
            customers, as well as our continuous innovation and pursuit of
            perfection in the hand tools industry. Thank you for being a part of
            our journey!
          </p>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-6 w-full mx-auto place-items-center">
          <Image
            src="/digital-top-brands.webp"
            width={800}
            height={800}
            alt="digital top brands"
            className="h-28 w-28 object-cover"
          />
          <Image
            src="/brand-choice-award.webp"
            width={800}
            height={800}
            alt="brand choice"
            className="h-28 w-28 object-cover"
