    ...
    return (
      <>
        <div className="min-h-[40vh] object-contain bg-[url(/blog-hero.webp)] bg-top bg-cover">
          <div
            className={`${montserrat.className} bg-black/60 min-h-[40vh] flex flex-col items-center justify-center text-center`}
          >
      ...
      <div className="flex flex-row w-full min-h-[500px] relative">
        ...
        <div className="w-2/5 bg-black z-10">
          <div className="bg-[#85E408] text-center w-full max-w-none px-12 py-24 flex flex-col gap-5 -ms-24 my-24 ">
            ...
            <p
              className={`${montserrat.className} items-center flex justify-center font-medium`}
            >
              <svg
                aria-hidden="true"
                ...
                <div className="flex items-stretch">
                  <div className="flex-1">
                    {prevPost ? (
                      ...
                      >
                        <span className="text-white text-2xl group-hover:text-[#85E408] transition-colors">
                          ‹
                        </span>
                        <div className="flex flex-col gap-1">
                          <span
                            className={`${montserrat.className} text-white text-xs uppercase tracking-wider`}
                          >
                            Previous
                          </span>
                          <span
                            className={`${roboto.className} text-white group-hover:text-[#85E408] transition-colors text-sm line-clamp-1`}
                          >
                            {prevPost.title}
                          </span>
                        </div>
                  ...
                  <div className="flex-1 text-right">
                    {nextPost ? (
                      <Link
                        ...
                        className="flex items-center justify-end gap-4 group h-full"
                      >
                        <div className="flex flex-col gap-1">
                          <span
                            className={`${montserrat.className} text-white text-xs uppercase tracking-wider`}
