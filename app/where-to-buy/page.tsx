  ...
  return (
    <>
      <div className="min-h-[65vh] object-contain bg-[url(/where-to-buy.webp)] bg-center bg-cover">
        <div
          className={`${montserrat.className} bg-black/70 min-h-[65vh] flex flex-col items-center justify-center text-center`}
        >
          <div className="flex flex-col justify-center text-center gap-10 max-w-5xl px-10">
            <h1 className="text-white font-semibold text-3xl lg:text-5xl uppercase">
      ...
      <div className="mt-24 grid grid-cols-1 md:grid-cols-4 gap-6 max-w-6xl mx-auto items-center px-10">
        ...
        <Link
          href="https://indoteknik.com/shop/brands/tekiro-10"
          target="_blank"
          rel="noopener noreferrer"
        >
          <Image
            src="/indoteknik-ecom.webp"
            alt="Indoteknik"
            width={600}
            height={400}
            className="w-3xs"
        ...
        <Link
          href="https://fixcomart.com/collections/tekiro"
          target="_blank"
          rel="noopener noreferrer"
        >
          <Image
            src="/fixcomart-ecom.webp"
            alt="Fixcomart"
            width={600}
            height={400}
            className="w-3xs"
        ...
        <Link
          href="https://www.blibli.com/brand/tekiro"
          target="_blank"
          rel="noopener noreferrer"
        >
          <Image
            src="/blibli-ecom.webp"
            alt="Blibli"
            width={600}
            height={400}
            className="w-3xs"
      ...
      <div className="py-16 w-full flex justify-center">
        <Link
          href="/contact"
          className="py-4 px-14 bg-[#61CE70] rounded-full text-white uppercase mx-auto"
        >
          contact us
        </Link>
      </div>
