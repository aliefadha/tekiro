...
function FAQSection() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Lokasi final nasional akan diumumkan setelah seleksi tahap 3 selesai."
        }
    ]
...
export default function EventsPage() {
    return (
        ...
        <div className="min-h-[500px] object-contain bg-[url(/events.webp)] bg-top bg-cover">
            <div className="bg-black/60 min-h-[500px]">
            </div>
        </div>

        <div className="relative">
            <div className={`${montserrat.className} container mx-auto px-4 py-16 md:py-24`}>
                <div className="max-w-4xl mx-auto text-center">
                    <h1 className="text-3xl font-bold mb-4">
                        TEKIRO MECHANIC COMPETITION 2026
                    </h1>
                    <p className="font-roboto mb-8">
                        Kompetisi Keahlian Teknik Sepeda Motor untuk<br />
        ...
        <div className={`${montserrat.className} container mx-auto px-4 py-16`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                ...
                <div className="bg-black p-3 group cursor-pointer">
                    ...
                    <p className="text-[#85E408] text-sm font-medium px-3 pb-3">
                        Menjadi wadah adu keterampilan antar sekolah secara sehat dan profesional.
                    </p>
                </div>
            ...
            <div className="bg-[#85E408] py-16 px-8 text-center">
                ...
                >
                    Lihat Selengkapnya
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.44141 1.14258L8.30859 0.275391C8.67578 -0.0917969 9.26953 -0.0917969 9.63281 0.275391L17.2266 7.86523C17.5938 8.23242 17.5938 8.82617 17.2266 9.18945L9.63281 16.7832C9.26562 17.1504 8.67188 17.1504 8.30859 16.7832L7.44141 15.916C7.07031 15.5449 7.07812 14.9395 7.45703 14.5762L12.1641 10.0918H0.9375C0.417969 10.0918 0 9.67383 0 9.1543V7.9043C0 7.38477 0.417969 6.9668 0.9375 6.9668H12.1641L7.45703 2.48242C7.07422 2.11914 7.06641 1.51367 7.44141 1.14258Z" fill="white"/>
                    </svg>
                </Link>
            </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                ...
                <div className="bg-black text-white">
                    ...
                    <div className="p-6">
                        ...
                        <p className="text-sm mb-3">Meliputi materi dasar teknik, seperti:</p>
                        <ul className="space-y-2 text-sm">
                            <li className="flex items-center gap-2">
                                <span className="text-[#85E408] mt-1">●</span>
                ...
                <div className="bg-black text-white">
                    ...
                    <div className="p-6">
                        ...
                        <p className="text-sm mb-3">Penilaian kompetensi secara langsung, seperti:</p>
                        <ul className="space-y-2 text-sm">
                            <li className="flex items-center gap-2">
                                <span className="text-[#85E408] mt-1">●</span>
                    ...
                    <div className="flex flex-col items-center text-center">
                        <div className="w-20 h-20 bg-[#85E408] border border-black flex items-center justify-center mb-4">
                            <svg width="39" height="39" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.66667 39V34.6667H17.3333V27.95C15.5639 27.5528 13.9844 26.8038 12.5948 25.7032C11.2053 24.6025 10.1848 23.2209 9.53333 21.5583C6.825 21.2333 4.55939 20.0511 2.7365 18.0115C0.913611 15.9719 0.00144444 13.5792 0 10.8333V8.66667C0 7.475 0.424667 6.45522 1.274 5.60733C2.12333 4.75944 3.14311 4.33478 4.33333 4.33333H8.66667V0H30.3333V4.33333H34.6667C35.8583 4.33333 36.8788 4.758 37.7282 5.60733C38.5775 6.45667 39.0014 7.47644 39 8.66667V10.8333C39 13.5778 38.0878 15.9705 36.2635 18.0115C34.4392 20.0525 32.1736 21.2348 29.4667 21.5583C28.8167 23.2194 27.7969 24.6011 26.4073 25.7032C25.0178 26.8053 23.4376 27.5542 21.6667 27.95V34.6667H30.3333V39H8.66667ZM8.66667 16.9V8.66667H4.33333V10.8333C4.33333 12.2056 4.73056 13.4427 5.525 14.5448C6.31945 15.6469 7.36667 16.432 8.66667 16.9ZM30.3333 16.9C31.6333 16.4306 32.6806 15.6448 33.475 14.5427C34.2694 13.4406 34.6667 12.2041 34.6667 10.8333V8.66667H30.3333V16.9Z" fill="#121212"/>
                            </svg>
                        </div>
                        <p className="font-medium">
                            Trophy dan penghargaan<br />
                            untuk sekolah.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col items-center text-center">
                        <div className="w-20 h-20 bg-[#85E408] border border-black flex items-center justify-center mb-4">
                            <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M21.6667 0C9.70667 0 0 9.70667 0 21.6667C0 33.6267 9.70667 43.3333 21.6667 43.3333C33.6267 43.3333 43.3333 33.6267 43.3333 21.6667C43.3333 9.70667 33.6267 0 21.6667 0ZM19.5 38.8483C10.9417 37.7867 4.33333 30.5067 4.33333 21.6667C4.33333 20.3233 4.50667 19.045 4.78833 17.7883L15.1667 28.1667V30.3333C15.1667 32.7167 17.1167 34.6667 19.5 34.6667V38.8483ZM34.45 33.345C33.8867 31.59 32.2833 30.3333 30.3333 30.3333H28.1667V23.8333C28.1667 22.6417 27.1917 21.6667 26 21.6667H13V17.3333H17.3333C18.525 17.3333 19.5 16.3583 19.5 15.1667V10.8333H23.8333C26.2167 10.8333 28.1667 8.88334 28.1667 6.5V5.61167C34.515 8.19 39 14.4083 39 21.6667C39 26.1733 37.2667 30.2683 34.45 33.345Z" fill="#121212"/>
                            </svg>
                        </div>
                        <p className="font-medium">
                            Kesempatan tampil di publikasi resmi<br />
                ...
                <div className="bg-gray-100 p-6 text-center">
                    <div className="flex items-center justify-center gap-2 mb-2">
                        <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20 0H0V16H20V0ZM18 4L10 9L2 4V2L10 7L18 2V4Z" fill="#85E408"/>
                        </svg>
