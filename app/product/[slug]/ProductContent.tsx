...
export default function ProductContent({ slug }: { slug: string }) {
  const { data: productResponse, isLoading: isProductLoading } = useProductById(slug)
  const product = productResponse?.data

  const { data: relatedResponse, isLoading: isRelatedLoading } = useRelatedProducts(product?.categoryId || "")
