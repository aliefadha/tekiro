            ...
            <div className="max-w-[1440px] mx-auto px-6 py-12 lg:px-12 grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-4">
                        {/* Facebook */}
                        <Link href="https://www.facebook.com/TekiroTools" target="_blank" rel="noopener noreferrer" className="bg-white rounded-full p-2 hover:bg-gray-100 transition-colors">
                        ...
                        {/* Instagram */}
                        <Link href="https://www.instagram.com/tekiro_tools/" target="_blank" rel="noopener noreferrer" className="bg-white rounded-full p-2 hover:bg-gray-100 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#427402]" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        {/* YouTube */}
                        <Link href="https://www.youtube.com/@TekiroIndonesia" target="_blank" rel="noopener noreferrer" className="bg-white rounded-full p-2 hover:bg-gray-100 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#427402]" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        {/* TikTok */}
                        <Link href="https://www.tiktok.com/@tekiroindonesia" target="_blank" rel="noopener noreferrer" className="bg-white rounded-full p-2 hover:bg-gray-100 transition-colors">
