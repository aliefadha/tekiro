      ...
      <div className="max-w-[1440px] mx-auto px-6 py-12 lg:px-12 grid grid-cols-1 md:grid-cols-3 gap-12">
        <div className="flex flex-col justify-between">
          <div>
            ...
            <p className="text-sm font-medium leading-relaxed max-w-sm mb-8">
              <span className="font-bold">TEKIRO Tools</span> is a trusted brand
              for high-quality hand tools product which provides wide range of
              product selections from industrial to home-use.
            </p>
          </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            {/* Facebook */}
            <Link
              href="https://www.facebook.com/TekiroTools"
              target="_blank"
            ...
            {/* Instagram */}
            <Link
              href="https://www.instagram.com/tekiro_tools/"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white rounded-full p-2 hover:bg-gray-100 transition-colors"
            >
            ...
            {/* YouTube */}
            <Link
              href="https://www.youtube.com/@TekiroIndonesia"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white rounded-full p-2 hover:bg-gray-100 transition-colors"
            >
            ...
            {/* TikTok */}
            <Link
              href="https://www.tiktok.com/@tekiroindonesia"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white rounded-full p-2 hover:bg-gray-100 transition-colors"
            >
