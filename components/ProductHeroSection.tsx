...
export default function ProductHeroSection() {
    ...
    return (
        <div className="w-full bg-[url(/product-hero.webp)] bg-top bg-cover">
            <div className="mx-auto flex flex-col lg:flex-row gap-20 bg-black/60 py-16 px-6 md:px-20 items-center justify-center">

                <div className="space-y-5 w-full lg:w-1/3 text-center lg:text-left">
