                ...
                {articles.map((post) => (
                    ...
                    >
                        <div className="w-full flex flex-col items-center gap-5 grow">
                            <Image src={post.primaryImage} alt={post.title} width={250} height={350} className="w-full h-[350px] mx-auto object-cover" />
                        ...
                        <Link href={`/blog/${post.slug}`} className="border-b-2 border-[#85E408] hover:bg-[#85E408] py-3 px-4 text-[#85E408] hover:text-black text-center" >
