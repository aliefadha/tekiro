...
export default function Modal({ isOpen, onClose, imageSrc, children }: ModalProps) {
    ...
    return (
        ...
        >
            <div
                ref={modalRef}
                className="relative bg-white shadow-xl w-full max-w-lg md:max-w-2xl transform transition-all duration-300 scale-100 opacity-100 flex flex-col max-h-[90vh]"
            >
                <button
                    onClick={onClose}
